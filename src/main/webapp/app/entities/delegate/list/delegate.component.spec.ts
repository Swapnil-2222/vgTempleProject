...
describe('Delegate Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'delegate', component: DelegateComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.delegates?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to delegateService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDelegateIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDelegateIdentifier).toHaveBeenCalledWith(entity);
